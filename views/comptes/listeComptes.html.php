        ...
        <div class="container mt-4 col-10">
            <table class="table mt-5 table table-striped table-hover table-bordered vw-50">
                <thead class="table-primary">
                    <tr>
                        <th scope="col text-align-center">Numéro</th>
                        <th scope="col text-align-center">Client</th>
                        <th scope="col text-align-center">Téléphone</th>
                        <th scope="col text-align-center">Email</th>
                        <th scope="col text-align-center">Solde</th>
                    </tr>
                </thead>
                <tbody>
